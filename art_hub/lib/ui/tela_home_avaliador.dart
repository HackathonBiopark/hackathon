...
class TelaHomeAvaliador extends StatefulWidget {
  ...
  @override
  State<TelaHomeAvaliador> createState() => _TelaHomeAvaliadorState();
}

class _TelaHomeAvaliadorState extends State<TelaHomeAvaliador> {
  @override
          ...
          children: [
            Expanded(
              child: _buildCardEvento(
                imagem: '../assets/img/imagem_avaliacao.jpg',
                titulo: 'Artigos disponíveis para avaliação',
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const TelaListaArtigos(),
                    ),
                  );
                },
              ),
